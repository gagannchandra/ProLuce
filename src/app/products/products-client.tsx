  ...
  return (
    <div className="pt-32 pb-24 bg-background min-h-screen">
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <div>
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-light text-foreground mb-6 tracking-wide leading-tight">Catalogue</h1>
          ...
          <div className="flex gap-4 w-full md:w-auto overflow-x-auto pb-4 md:pb-0 hide-scrollbar" style={{ WebkitOverflowScrolling: 'touch' }}>
